...
all: main.o expr.o scanner.o parser.tab.o
	gcc main.o expr.o scanner.o parser.tab.o -o calc -lm
...
scanner.c: calc.flex parser.tab.h
	flex -oscanner.c calc.flex

parser.tab.c parser.tab.h: calc.bison
	yacc -d -bparser -v calc.bison

# clean causes all intermediate files to be deleted.

clean:
	rm -f parser.tab.* parser.output scanner.c *.o calc
